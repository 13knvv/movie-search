  ...
  return (<>
    ...
    <div className={s.scrollContainer}>
      <div className={s.wrappForArrow}>
        <button className={s.beforeArrow + ' ' + (props.isBeforeArrowDisabled ? s.arrowDisabled : '')}
      ...
      <div className={s.scrollWrapp}>
        ...
        <button className={s.nextArrow + ' ' + (props.isNextArrowDisabled ? s.arrowDisabled : '')}
    ...
    <div className={s.linkMore}>
      <NavLink to={props.link} >Смотреть еще...</NavLink>
    </div>
  </>)
}
